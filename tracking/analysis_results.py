...
for epoch in range(301,302):
    ...
    trackers.extend(trackerlist(name='FERMT', parameter_name='mLSTM-'+str(epoch), dataset_name=dataset_name,
                            run_ids=None, display_name='mLSTM-'+str(epoch)))
